  ...
  const deleteProfile = async (e) => {
    ...
    try {
      const deleteprofile = await axios.delete(
        `https://energy-app-backend.vercel.app/api/auth/userDel/${userid}`
      );
  ...
  const postupdate = async (e) => {
    ...
    try {
      const upd = await axios.put(
        `https://energy-app-backend.vercel.app/api/auth/userupd/${userid}`,
        data,
  ...
  const getuser = async () => {
    ...
    try {
      const getuser = await axios.get(
        `https://energy-app-backend.vercel.app/api/auth/getuser/${userid}`
      );
