...
function UserAuct() {
  ...
  const getorders = async () => {
    try {
      const userOrder = await axios.get(
        `https://energy-app-backend.vercel.app/api/auct/userOrder/${userid}`
      );
  ...
  const getbids = async () => {
    try {
      const userOrder = await axios.get(
        `https://energy-app-backend.vercel.app/api/auct/userbids/${userid}`
      );
  ...
  //     const response = await fetch("https://energy-app-backend.vercel.app/api/auct/stripe/pay", {
  //       method: "POST",
  //       headers: headers,
