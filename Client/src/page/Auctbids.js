...
const Auctbids = () => {
  ...
  const getbids = async () => {
    try {
      const res = await axios.get(
        "https://energy-app-backend.vercel.app/api/auct/bids/" + productid
      );
  ...
  //      const auction = await axios.get(`https://energy-app-backend.vercel.app/api/auct/auctionOrd/${id}`)
  ...
  const makePayment = async (Amount, bidID) => {
    ...
    try {
      ...
      const response = await fetch(
        "https://energy-app-backend.vercel.app/api/auct/stripe/pay",
        {
          method: "POST",
          headers: headers,
  ...
  const Acceptbid = async (id) => {
    ...
    try {
      const accept = await axios.put(
        `https://energy-app-backend.vercel.app/api/auct/bidAcc/${id}`
      );
  ...
  const deleteitem = async (id) => {
    try {
      const deleteitem = await axios.delete(
        `https://energy-app-backend.vercel.app/api/auct/bidDel/${id}`
      );
