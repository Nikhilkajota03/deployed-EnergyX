...
function Success() {
  ...
  //   await axios.post("https://energy-app-backend.vercel.app/api/auct/stripe/Tra", data);
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const auctionTra =  await axios.post("https://energy-app-backend.vercel.app/api/auct/stripe/Tra", data);
  
        

       
        const status = await axios.put("https://energy-app-backend.vercel.app/api/auct/status", data);
